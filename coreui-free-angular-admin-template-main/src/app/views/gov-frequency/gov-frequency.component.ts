...
import { FrequencyService, FrequencyData } from '../gov-frequency/gov-frequency.service';
...
@Component({
  selector: 'app-gov-frequency',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './gov-frequency.component.html',
  styleUrls: ['./gov-frequency.component.scss']
})
export class GovFrequencyComponent implements OnInit {
  tabs: TabDef[] = [
    { key: 'portable', label: 'Portable Government' },
    { key: 'fb',       label: 'FB Government' },
    { key: 'mobile',   label: 'Mobile Government' },
    { key: 'fx',       label: 'FX Government' },
  ...
  constructor(private router: Router, private freqService: FrequencyService) {}

  ngOnInit(): void { this.loadData(); }

  loadData(): void {
    this.tabs.forEach(tab => {
      this.freqService.getGovDataByType(tab.key).subscribe({
        next: (data) => {
